...
import { summary as mk } from "../src/data/countries/mk/summary";
import { summary as me } from "../src/data/countries/me/summary";
import { summary as kr } from "../src/data/countries/kr/summary";
import { summary as cy } from "../src/data/countries/cy/summary";
import { summary as gr } from "../src/data/countries/gr/summary";
import { summary as si } from "../src/data/countries/si/summary";
import { summary as hr } from "../src/data/countries/hr/summary";
import { summary as de } from "../src/data/countries/de/summary";
import { summary as fi } from "../src/data/countries/fi/summary";

for (const s of [uz, sco, it, at, se, jp, ge, am, kz, mn, cn, ro, bg, rs, ba, al, md, ee, lv, lt, pl, tr, kg, hu, sk, mk, me, kr, cy, gr, si, hr, de, fi]) {
